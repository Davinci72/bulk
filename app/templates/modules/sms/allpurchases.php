...
<form action="" role="form" class="form-inline" method="post">
    <div class="form-group" id="data_5">
        ...
        <input type="text" placeholder="Reference" class="input-sm form-control">
    </div>
 <div class="form-group">
        <input type="text" placeholder="Paid By" class="input-sm form-control">
    </div>
    <div class="input-group">
    ...
    <button class="input-sm btn btn-success" type="submit">Search <i class="fa fa-search"></i></button>
</form>
<div class="hr-line-dashed"></div>
 <form>
